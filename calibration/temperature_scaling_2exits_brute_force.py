...
# Instead of using a loss x backward approach to look for the the optimimal temperature, we will use a brute force approach
# trying all the temperatures from 0.001 to 10.000 in steps of 0.001
